onload = () =>{
    ...
    document.querySelector('#bt-mais').onclick = () => digito()
    document.querySelector('#bt-menos').onclick = () => digito()
    document.querySelector('#bt-multi').onclick = () => digito()
    document.querySelector('#bt-div').onclick = () => digito()
